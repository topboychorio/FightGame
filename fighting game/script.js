// ** elements from the DOM and stored them into variables **
...
let player1 = new Player("David", 100, 15);
let player2 = new Player("Chorio", 100, 15);
...
//Functionality where players can press a button to attack OR heal
